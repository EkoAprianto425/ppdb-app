...
@if(in_array(auth()->user()->role, [\App\Models\User::ROLE_ADMIN_SMP, \App\Models\User::ROLE_ADMIN_SMA, \App\Models\User::ROLE_ADMIN_SMK, \App\Models\User::ROLE_SUPER_ADMIN, \App\Models\User::ROLE_ADMIN_ADM]))
