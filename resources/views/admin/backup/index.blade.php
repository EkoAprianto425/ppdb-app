...
<div class="space-y-6">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="text-2xl font-bold text-white">Manajemen Pencadangan</h2>
            <p class="text-white/60 text-sm">Cadangkan atau pulihkan data penting sistem PPDB</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {{-- Kolom Backup --}}
        <div class="space-y-6">
            <h3 class="text-lg font-bold text-white mb-4">Pencadangan Data (Backup)</h3>

            {{-- Backup Database --}}
            <div class="p-6 rounded-3xl bg-slate-800/50 border border-white/5 backdrop-blur-xl relative overflow-hidden group hover:border-indigo-500/30 transition-all">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-bold text-white mb-2">Database SQL</h4>
                        <p class="text-sm text-white/60 mb-6">Unduh seluruh data registrasi, pengaturan, dan akun pengguna dalam format .sql.</p>
            ...
            <div class="p-6 rounded-3xl bg-slate-800/50 border border-white/5 backdrop-blur-xl relative overflow-hidden group hover:border-emerald-500/30 transition-all">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-bold text-white mb-2">Bukti Pembayaran (ZIP)</h4>
                        <p class="text-sm text-white/60 mb-6">Unduh semua file gambar bukti pembayaran siswa untuk Tahun Ajaran yang aktif saat ini.</p>
        ...
        {{-- Kolom Restore --}}
        <div class="space-y-6">
            <h3 class="text-lg font-bold text-white mb-4">Pemulihan Data (Restore)</h3>

            {{-- Restore Database --}}
            <div class="p-6 rounded-3xl bg-slate-800/50 border border-rose-500/20 backdrop-blur-xl relative overflow-hidden group transition-all">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-bold text-white mb-2">Restore Database</h4>
                        <p class="text-sm text-rose-400 mb-6 font-bold">Peringatan: Aksi ini akan menimpa seluruh data yang ada di database saat ini!</p>
                        
                        <form action="{{ route('admin.backup.restore-db') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="flex items-center gap-3">
                                <input type="file" name="sql_file" accept=".sql" required class="block w-full text-sm text-white/60 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-rose-500/20 file:text-rose-400 hover:file:bg-rose-500/30">
            ...
            <div class="p-6 rounded-3xl bg-slate-800/50 border border-white/5 backdrop-blur-xl relative overflow-hidden group transition-all">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-bold text-white mb-2">Restore Bukti Pembayaran</h4>
                        <p class="text-sm text-white/60 mb-6">Unggah file ZIP berisi gambar bukti pembayaran untuk memulihkannya.</p>
                        
                        <form action="{{ route('admin.backup.restore-proofs') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="flex items-center gap-3">
                                <input type="file" name="zip_file" accept=".zip" required class="block w-full text-sm text-white/60 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-amber-500/20 file:text-amber-400 hover:file:bg-amber-500/30">
