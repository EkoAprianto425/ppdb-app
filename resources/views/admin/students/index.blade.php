                ...
                <tr class="hover:bg-primary/5 transition-colors group">
                    ...
                    <td class="px-8 py-5 text-right">
                        <div class="flex justify-end gap-2">
                            <a href="{{ $student->registration ? route('admin.students.show', $student->registration) : route('admin.students.show-by-user', $student) }}" class="p-2 rounded-lg btn-action-view" title="Lihat Detail">
