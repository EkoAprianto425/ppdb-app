    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <form action="{{ route('admin.financial.payments') }}" method="GET" class="flex items-end gap-3 min-w-[300px]">
            ...
            @if(in_array($status, ['success', 'belum_lunas']))
                <a href="{{ route('admin.financial.payments.export', ['status' => $status, 'level_id' => request('level_id')]) }}"
                   class="px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold uppercase tracking-widest transition-all shadow-lg shadow-emerald-900/30 flex items-center gap-2 whitespace-nowrap">
