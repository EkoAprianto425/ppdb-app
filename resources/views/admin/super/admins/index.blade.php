...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <!-- Edit Modal -->
    <div x-show="showEditModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" x-cloak style="display: none;" x-transition>
        <div class="card-glass rounded-3xl p-8 w-full max-w-md relative" @click.away="showEditModal = false">
            <button @click="showEditModal = false" class="absolute top-4 right-4 text-gray-500 hover:text-gray-700">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
            </button>
            <h3 class="text-lg font-bold themed-text mb-6">Edit Admin</h3>
            <form :action="`/admin/users/${editAdmin.id}`" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-bold themed-text-muted uppercase tracking-widest mb-2">Password (Kosongkan jika tidak diubah)</label>
                    <div class="relative">
                ...
                <button type="submit" class="w-full py-3 rounded-xl btn-soft-primary font-bold uppercase tracking-widest text-xs">Simpan Perubahan</button>
            </form>
        </div>
    </div>
</div>
