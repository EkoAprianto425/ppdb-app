...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="card-glass rounded-3xl p-6 border-l-4 border-purple-500">
        ...
        @if(!$hasRegistration)
            ...
            <span class="px-3 py-1 rounded-full text-[9px] font-black uppercase border bg-slate-700/50 text-slate-400 border-slate-700">Menunggu Formulir</span>
        @elseif($activeFee)
    ...
    <div class="card-glass rounded-3xl p-6 border-l-4 border-blue-500">
        ...
        @elseif($status1 !== 'success')
            ...
            <span class="px-3 py-1 rounded-full text-[9px] font-black uppercase border bg-slate-700/50 text-slate-400 border-slate-700">Belum Tersedia</span>
        @elseif($schedules->count() === 0)
            ...
            <span class="px-3 py-1 rounded-full text-[9px] font-black uppercase border bg-slate-700/50 text-slate-400 border-slate-700">Belum Dijadwalkan</span>
        @else
    ...
    <div class="card-glass rounded-3xl p-6 border-l-4 {{ $isPassed ? 'border-emerald-500' : ($isNotPassed ? 'border-rose-500' : 'border-amber-500') }}">
        ...
        @elseif(!$hasExam)
            ...
            <span class="px-3 py-1 rounded-full text-[9px] font-black uppercase border bg-slate-700/50 text-slate-400 border-slate-700">Menunggu Ujian</span>
        @else
