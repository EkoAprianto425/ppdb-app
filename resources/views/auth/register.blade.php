                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="password" type="password" name="password"
                                   ...
                                   class="w-full px-4 py-2.5 rounded-xl bg-white border {{ $errors->has('password') ? 'border-red-500/50' : 'border-amber-900/20' }} text-amber-950 text-sm placeholder-slate-500 focus:outline-none focus:border-amber-700 focus:ring-1 focus:ring-amber-700/30 shadow-sm transition-all">
                        ...
                        <div>
                            ...
                            <input id="password_confirmation" type="password" name="password_confirmation"
                                   ...
                                   class="w-full px-4 py-2.5 rounded-xl bg-white border border-amber-900/20 text-amber-950 text-sm placeholder-slate-500 focus:outline-none focus:border-amber-700 focus:ring-1 focus:ring-amber-700/30 shadow-sm transition-all">
                        </div>
                    </div>
                </div>
