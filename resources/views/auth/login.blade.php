            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input id="password" type="password" name="password" autocomplete="current-password"
                           ...
                           class="w-full px-4 py-3 rounded-xl bg-white border {{ $errors->has('password') ? 'border-red-500/50' : 'border-amber-900/20' }} text-amber-950 text-sm placeholder-amber-900/40 focus:outline-none focus:border-amber-700 focus:ring-1 focus:ring-amber-700/30 transition-all shadow-sm">
