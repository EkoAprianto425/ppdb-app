...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:admin_smp,admin_sma,admin_smk,admin_administrasi,super_admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware(['role:super_admin'])->group(function () {
            ...
            Route::resource('information-sources', \App\Http\Controllers\Admin\InformationSourceController::class)->name('information-sources.index');
            Route::resource('school-reasons', \App\Http\Controllers\Admin\SchoolReasonController::class)->name('school-reasons.index');
